...
The frontend is an exploratory prototype intended to demonstrate a possible use case for the [formation data - full API endpoint](https://api.opentransportdata.swiss/formation/v1/formations_full) and uses the [train-view-svg-library](https://github.com/jexnator/train-view-svg-library), which is licensed separately under CC BY 4.0.
